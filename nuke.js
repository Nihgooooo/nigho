...
if(newMember.id === "311055977266806785") {
    let lol = bot.users.find(r=> r.id === "311055977266806785").presence.game
    let lolcase = lol == null ? lol : lol.name
    let lol2 = bot.users.find(r=> r.id === "311055977266806785").presence.status
...
bot.on('message', message => {
	if(message.author.id === "311055977266806785") {
		message.delete()
